...
<html>
  ...
  <div class="mystil">
    ...
    <table class="mytable" width="90%">
      <caption>Employee for Department: '${modelDepartment.departmentName}'</caption>
      <tr>
        <th>ID</th>
        <th>Department</th>
        <th>Name</th>
      ...
      <c:forEach var="employee" items="${modelEmployeeList}" varStatus="status">
        <tr>
          <td>${employee.id}</td>
          <td>${modelDepartment.departmentName}</td>
      ...
      <form id="delete_Employee" method="post" modelAttribute="modelEmployee" action="delete_Employee">
    ...
    <div align="center">
      <form method="get" modelAttribute="modelDepartment" action="add_Employee">
         <label>Add new 'Employee' for Department: '${modelDepartment.departmentName}'</label>
         <input type="hidden" name="id" value=${modelDepartment.id}>
         <input type="submit" value="Add" class="myinput">
      </form>
      <br><br><br>
      <form action="../department/table_Department">
